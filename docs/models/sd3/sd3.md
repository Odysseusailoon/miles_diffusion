...
Observed per-component rewards from one `scripts/run_diffusion_grpo_sd3_ocr_pickscore_sglang.py` run
(600 rollouts), bold lines are 10-rollout moving averages:

![Flow-GRPO OCR + PickScore mixture reward](../../assets/images/sd3/grpo-ocr-pickscore-mixture-reward.png)
